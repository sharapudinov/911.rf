...
$APPLICATION->SetTitle("Кузовный работы");
?>
    <style>
        * {
            font-family: 'PT Sans', 'Roboto', Ubuntu, Arial, sans-serif;
        }

        #reformal_tab, #footer, #site-nav-bar {
            display: none !important;
        }

        #simple-quote-request-modal h3.simple-quote-request-modal-header {
            margin: 0 0 1em;
        }

        #simple-quote-request-modal .text-muted {
            display: none;
        }

        body.operator-available .operator-unavailable {
            display: none !important;
        }

        body.operator-unavailable .operator-available {
            display: none !important;
        }

        #landing-nav .navbar-brand,
        #landing-nav .navbar-text .phone {
            font-weight: 700;
        }
    ...
    <style>
        #header {
            background: #aaa url("/mechanics/assets/files/137890/to-filter-change-bg.jpg");
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 title-block">
                    <h1>Расчет стоимости проведения техобслуживания вашего автомобиля на&nbsp;выезде</h1>
                    <h2>Автоматически подберем необходимые запчасти по&nbsp;лучшей цене от&nbsp;нескольких оптовых
                        поставщиков. Расчитаем полную стоимость работ и&nbsp;запчастей. Приедем и&nbsp;проведем
                        необходимые работы в&nbsp;выбранное вами время на&nbsp;парковке у&nbsp;офиса или дома, или в&nbsp;другом
                        удобном вам месте</h2>
        ...
        <div class="container">
            ...
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <th class="text-center">Цены в&nbsp;сервисе (руб)</th>
                    <th class="success text-center lead">Мой Механик (руб)</th>
                </tr>
                </thead>
                <tbody>
                <tr>
                    ...
                    <td class="text-center">12&nbsp;458&ndash;15&nbsp;610</td>
                    <td class="success text-center lead">10&nbsp;536</td>
                </tr>
                <tr>
                    <td>Honda CR-V 2.4 (2010)</td>
                    <td class="text-center">60&nbsp;000</td>
                    <td class="text-center">10&nbsp;880&ndash;14&nbsp;927</td>
                    <td class="success text-center lead">9&nbsp;422</td>
                </tr>
                <tr>
                    <td>Volkswagen Polo 1.6 (2011)</td>
                    <td class="text-center">60&nbsp;000</td>
                    <td class="text-center">14&nbsp;120&ndash;16&nbsp;048</td>
                    <td class="success text-center lead">11&nbsp;755</td>
                </tr>
                <tr>
                    <td>Ford Focus 1.4 (2004)</td>
                    <td class="text-center">100&nbsp;000</td>
                    <td class="text-center">10&nbsp;780&ndash;23&nbsp;587</td>
                    <td class="success text-center lead">8&nbsp;838</td>
                </tr>
                </tbody>
            </table>
            ...
            <h3 class="text-center">или техобслуживание <a href="#">рекомендованное производителем
                    по пробегу</a></h3>
            ...
            <div class="row mtb text-center">
                <div class="1col-md-10 1col-md-offset-1">
                    <div class="col-md-4 prices">
                        ...
                        <a href="#" class="btn btn-lg btn-red click-event" role="button"
