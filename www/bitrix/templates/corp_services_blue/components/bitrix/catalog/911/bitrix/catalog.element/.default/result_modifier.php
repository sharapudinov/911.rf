...
$rsOf = CIBlockElement::GetList(
    array(),
    array(
        "IBLOCK_ID" => 4,
        "ID" => $arResult['PROPERTIES']['FIRST_OFFER']['VALUE']),
    false,
    false,
    array(
        "ID",
...
$arEl = $rsOf->GetNext();
$arResult['PROPERTIES']['FIRST_OFFER']['arEl'] = $arEl;

$rsOf = CIBlockElement::GetList(
    array(),
    array(
        "IBLOCK_ID" => 4,
        "ID" => $arResult['PROPERTIES']['SECOND_OFFER']['VALUE']),
    false,
    false,
    array(
        "ID",
...
$arEl = $rsOf->GetNext();
$arResult['PROPERTIES']['SECOND_OFFER']['arEl'] = $arEl;

$rsOf = CIBlockElement::GetList(
    array(),
    array(
        "IBLOCK_ID" => 4,
        "ID" => $arResult['PROPERTIES']['THIRD_OFFER']['VALUE']),
    false,
    false,
    array(
        "ID",
...
$arEl = $rsOf->GetNext();
$arResult['PROPERTIES']['THIRD_OFFER']['arEl'] = $arEl;
